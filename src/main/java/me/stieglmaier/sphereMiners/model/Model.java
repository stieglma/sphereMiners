...
public class Model extends Observable {
    ...
    private static class Simulation extends Thread {
        ...
        public Simulation(AIManager ais, Physics physics,
                          List<Player> aisToPlay, Constants constants,
        ...
        public void run() {
            ...
            if (loadingStatus.values().contains(LoadingStatus.INITIALIZING_FAILED)) {
                ...
                Platform.runLater(() -> ErrorPopup.create("Error while loading AIs",
            ...
            badAICallback.accept(loadingStatus.entrySet()
                         .stream()
